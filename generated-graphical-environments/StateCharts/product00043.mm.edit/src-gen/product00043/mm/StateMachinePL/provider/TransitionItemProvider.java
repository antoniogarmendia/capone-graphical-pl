...
/**
 * This is the item provider adapter for a {@link product00043.mm.StateMachinePL.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_from_feature",
								"_UI_Transition_type"),
						StateMachinePLPackage.Literals.TRANSITION__FROM, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_to_feature",
								"_UI_Transition_type"),
						StateMachinePLPackage.Literals.TRANSITION__TO, true, false, true, null, null, null));
	}
	...
	protected void addTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Transition_time_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_time_feature",
								"_UI_Transition_type"),
						StateMachinePLPackage.Literals.TRANSITION__TIME, true, false, false,
	...
	protected void addIsImmediatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Transition_isImmediate_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_isImmediate_feature",
								"_UI_Transition_type"),
						StateMachinePLPackage.Literals.TRANSITION__IS_IMMEDIATE, true, false, false,
