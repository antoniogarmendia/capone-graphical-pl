 ...
 * @generated
 */
public class StateMachinePLSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case StateMachinePLPackage.ORTHOGONAL_REGION: {
			OrthogonalRegion orthogonalRegion = (OrthogonalRegion) theEObject;
			T result = caseOrthogonalRegion(orthogonalRegion);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Orthogonal Region</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Orthogonal Region</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOrthogonalRegion(OrthogonalRegion object) {
		return null;
	}
