 ...
 * @generated
 */
public class NetworkingPLSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case NetworkingPLPackage.NETWORK: {
		...
		case NetworkingPLPackage.MESSAGE: {
