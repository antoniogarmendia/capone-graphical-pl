...
/**
 * This is the item provider adapter for a {@link product00005.mm.NetworkingPL.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addFromPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Link_from_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Link_from_feature", "_UI_Link_type"),
						NetworkingPLPackage.Literals.LINK__FROM, true, false, true, null, null, null));
	}
	...
	protected void addToPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Link_to_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Link_to_feature", "_UI_Link_type"),
						NetworkingPLPackage.Literals.LINK__TO, true, false, true, null, null, null));
	}
	...
	protected void addSpeedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Link_speed_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Link_speed_feature", "_UI_Link_type"),
						NetworkingPLPackage.Literals.LINK__SPEED, true, false, false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Link_type") + " " + link.getSpeed();
	}
