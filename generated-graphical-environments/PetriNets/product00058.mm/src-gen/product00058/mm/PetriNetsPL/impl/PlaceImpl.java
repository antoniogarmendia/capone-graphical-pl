 ...
 * </p>
 * <ul>
 *   <li>{@link product00058.mm.PetriNetsPL.impl.PlaceImpl#getTokens <em>Tokens</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceImpl extends MinimalEObjectImpl.Container implements Place {
	...
	protected EClass eStaticClass() {
		return PetriNetsPLPackage.Literals.PLACE;
	}
	...
	public void setTokens(int newTokens) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetriNetsPLPackage.PLACE__TOKENS, oldTokens, tokens));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PetriNetsPLPackage.PLACE__TOKENS:
			return getTokens();
		}
