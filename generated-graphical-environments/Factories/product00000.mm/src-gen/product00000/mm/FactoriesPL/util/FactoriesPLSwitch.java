 ...
 * @generated
 */
public class FactoriesPLSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case FactoriesPLPackage.CONVEYOR: {
			...
			if (result == null)
				result = caseFElement(conveyor);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case FactoriesPLPackage.FELEMENT: {
			FElement fElement = (FElement) theEObject;
			T result = caseFElement(fElement);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>FElement</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>FElement</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFElement(FElement object) {
		return null;
	}
